                            ...
                            @foreach($statuses as $status)
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm mr-1" data-toggle="modal" data-target="#exampleModal{{$status->id}}">
                                            Удалить
                                        </button>
                                        ...
                                        <a href="{{route('status.edit' ,['id'=>$status->id ])}}" class="btn-sm btn btn-primary">Изменить</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
